...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = angular.module('commonDirective', []).directive('markDown', function () {
	    ...
	    return {
	        ...
	        template: '<div class="public-loading" ng-show="!isCompleted">' + '<div class="rect1"></div>' + '<div class="rect2"></div>' + '<div class="rect3"></div>' + '<div class="rect4"></div>' + '<div class="rect5"></div>' + '</div>',
	        link: function link(scope, ele, attr) {}
	    };
	}]);
